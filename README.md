...
|-------|--------|--------|--------|-----------|---------------|---------|
|2020|**Revisiting Adversarially Learned Injection Attacks Against Recommender Systems**| Attack | MF,NCF,MultiVAE,ItemCF | RecSys | [Link](https://dl.acm.org/doi/10.1145/3383313.3412243)| [Code](https://github.com/graytowne/revisit_adv_rec)|
...
|2020|**Adversarial Item Promotion: Vulnerabilities at the Core of Top-N Recommenders that Use Images to Address Cold Start**| Attack | DVBPR/VBPR/AMR | arXiv| [Link](https://arxiv.org/abs/2006.01888)| [Code](https://github.com/liuzrcc/AIP)|
